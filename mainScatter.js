...
var currentVarName;
var bars = {};
function drawScatter(error, data0) {
    var type = data0.type;
    var traits = [];
    var data = data0.data;
    ...
    var size = 280, padding = 20, n = 4;
    var x = {}, y = {};
    traits.forEach(function (trait) {
        // Coerce values to numbers.
        data.forEach(function (d) { d[trait] = +d[trait]; });
        var value = function (d) { return d[trait]; }, domain = [d3.min(data, value), d3.max(data, value)], range = [padding / 2, size - padding / 2];
